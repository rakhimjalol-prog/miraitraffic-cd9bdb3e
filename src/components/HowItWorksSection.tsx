...
const HowItWorksSection = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-cyan-200 to-blue-300">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            {choose(
              "Complete your traffic school requirements in just 4 simple steps",
              "交通学校の要件をわずか4つの簡単なステップで完了",
              language
            )}
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="text-center bg-white rounded-lg p-6 shadow-sm">
            ...
            <p className="text-gray-600">
              {choose(
                "Complete the final exam to demonstrate your knowledge",
                "最終試験を完了して知識を証明",
                language
              )}
            </p>
