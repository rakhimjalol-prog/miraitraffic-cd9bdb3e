...
const CourseFeatureSection = () => {
  ...
  return <section className="py-20 bg-[#71d4f6]/30 overflow-hidden rounded-2xl">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-slide-in-left-slow">
            ...
            <ul className="space-y-3 mt-6">
              {syllabus.map((item, index) => <li key={index} className="flex items-center space-x-4 bg-white rounded-xl px-5 py-3 shadow transition hover:shadow-md animate-fade-in" style={{
