                ...
                <div className="space-y-6">
                  ...
                  <div className="prose prose-lg max-w-none">
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      <li><strong>2019 – {lang === 'jp' ? 'ビジョンの始まり' : 'The Vision Begins'}:</strong> {lang === 'jp' ? '日本語話者が直面する言語や法的な障壁を支援するために交通スクールを設立するという構想が始まりました。' : 'Our founder envisioned a traffic school to support Japanese speakers facing language and legal barriers in California.'}</li>
                      <li><strong>2020–2023 – {lang === 'jp' ? 'コース開発' : 'Course Development'}:</strong> {lang === 'jp' ? 'DMV顧問やバイリンガル教育者と連携し、分かりやすく準拠した日本語コースを作成しました。' : 'We partnered with DMV advisors and bilingual educators to create a compliant, easy-to-understand Japanese course.'}</li>
                      <li><strong>2024–2025 – {lang === 'jp' ? 'DMV認可と公開' : 'DMV Approval & Public Launch'}:</strong> {lang === 'jp' ? 'DMVから正式に承認され、カリフォルニア州全体で日本語話者向けにサービスを開始しました。' : 'Our course received official DMV approval and launched across California to serve the Japanese-speaking community.'}</li>
                    </ul>

                    <p className="mt-6">
                      {lang === 'jp' ? 'ミライ交通スクールは、カリフォルニア州のDMVにより正式に認可された完全オンラインの交通スクールです。日本語を話すドライバーの方々に向けて、母国語で簡単かつ便利に、裁判所とDMVの要件を満たすお手伝いをします。' : 'Mirai Traffic School offers a fully online traffic school course, officially licensed by the California Department of Motor Vehicles (DMV). Our program is designed specifically for Japanese-speaking drivers in California. We make it easy and convenient to meet both court and DMV requirements — all in your native language, from the comfort of your home.'}
                    </p>
