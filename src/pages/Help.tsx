...
const Help = () => {
  ...
  // 1. About the Course
  {
    question: choose("What is Mirai Traffic School?", "Miraiトラフィックスクールとは何ですか？", language),
    answer: choose("Mirai Traffic School is an online traffic school designed for Japanese-speaking drivers in California. Our course helps you meet court or DMV requirements to dismiss a traffic ticket and avoid points on your driving record.", "Miraiトラフィックスクールは、カリフォルニア州の日本語話者向けに設計されたオンライン交通学校です。違反チケットの取り消しや運転記録へのポイント付加を防ぐために、裁判所やDMVの要件を満たすことができます。", language)
  },
  {
    question: choose("Is the course approved by the California DMV?", "このコースはカリフォルニア州DMVに承認されていますか？", language),
    answer: choose("Yes. Our course is licensed by the California DMV. However, DMV approval does not imply endorsement.", "はい。当コースはカリフォルニア州DMVによって認可されています。ただし、承認は推奨を意味するものではありません。", language)
  },
  {
    question: choose("How long is the course?", "コースの所要時間はどれくらいですか？", language),
    answer: choose("The California DMV requires that online traffic school courses take a minimum of 340 minutes (about 5.5 hours). You can complete the course at your own pace, and your progress is saved automatically.", "カリフォルニア州DMVは、オンライン交通学校コースに最低340分（約5.5時間）の所要時間を義務付けています。自分のペースで進めることができ、進捗は自動的に保存されます。", language)
  },
  {
    question: choose("How does identity verification work during the course?", "コース中の本人確認はどのように行われますか？", language),
    answer: choose("As required by the DMV, we verify your identity using your date of birth and periodic security questions throughout the course.", "DMVの要件により、誕生日や定期的なセキュリティ質問を通じて本人確認を行います。", language)
  },
  {
    question: choose("Will there be videos in the course?", "コースにはビデオがありますか？", language),
    answer: choose("Yes! The course includes 14 short, animated videos to help you understand California traffic laws in an easy and engaging way.", "はい！このコースには、カリフォルニアの交通法をわかりやすく学べる14本の短いアニメーション動画が含まれています。", language)
  },

  // 2. Registration & Access
  {
    question: choose("How do I sign up for the course?", "コースの登録方法は？", language),
    answer: choose("Click the “Enroll Now” button on our website, enter your information, and complete payment. You’ll receive login instructions by email.", "ウェブサイトの「今すぐ登録」ボタンをクリックし、必要情報を入力して支払いを完了してください。ログイン手順はメールで届きます。", language)
  },
  {
    question: choose("How long do I have to complete the course?", "コース完了までの有効期限は？", language),
  ...
  // 3. Quizzes, Final Exam & Certificate
  {
    question: choose("Are there quizzes in the course?", "コースには小テストがありますか？", language),
    answer: choose("Yes. You’ll take a short quiz after each section. You must score at least 70% to pass each quiz.", "はい。各セクションの後に短い小テストがあります。各テストでは70%以上の正答率が必要です。", language)
  },
  {
    question: choose("Is there a final exam?", "最終試験はありますか？", language),
    answer: choose("Yes. At the end of the course, you must pass a final exam with a score of 70% or higher. You may attempt the final exam up to two times.", "はい。コース終了時に最終試験があり、70%以上の正答率で合格となります。最終試験は2回まで受けられます。", language)
  },
  {
    question: choose("What happens if I fail a quiz?", "小テストに不合格になったらどうなりますか？", language),
    answer: choose("You can retake each quiz as many times as needed until you pass.", "合格するまで何度でも再受験できます。", language)
  },
  {
    question: choose("When is my certificate sent to the DMV?", "修了証明書はいつDMVに送られますか？", language),
    answer: choose("As soon as you pass the final exam, your completion certificate is submitted electronically to the DMV. You’ll also receive a copy for your records.", "最終試験に合格すると、修了証明書は自動的にDMVへ電子送信されます。ご自身の控えもメールで届きます。", language)
  },

  // 4. Payments & Refunds
  {
    question: choose("What payment methods do you accept?", "どのような支払い方法に対応していますか？", language),
    answer: choose("We accept all major credit and debit cards through our secure payment partner, Stripe. You may also see options like PayPal, Apple Pay, or Google Pay depending on your device.", "Stripeを通じて、主要なクレジットカードとデビットカードがご利用いただけます。デバイスによってはPayPal、Apple Pay、Google Payも表示される場合があります。", language)
  },
  {
    question: choose("Is there a refund policy?", "返金ポリシーはありますか？", language),
    answer: choose("Yes. Refunds are available if you have not yet started the course. Once you begin the course, refunds are no longer available.", "はい。コースをまだ開始していない場合は返金が可能です。一度開始すると返金はできません。", language)
  },

  // 5. Technical Support
  {
    question: choose("Can I switch devices during the course?", "受講中にデバイスを切り替えることはできますか？", language),
    answer: choose("Yes. Your progress is automatically saved. You can log in from any device and continue right where you left off.", "はい。進捗は自動的に保存され、どのデバイスからでもログインして続きから始めることができます。", language)
  },
  {
    question: choose("What if I forget my login details?", "ログイン情報を忘れた場合は？", language),
    answer: choose("Click “Forgot Password” on the login page or contact us at support@miraitraffic.com for help.", "ログインページの「パスワードをお忘れですか？」をクリックするか、support@miraitraffic.comまでご連絡ください。", language)
  },

  // 6. Language Options
  {
    question: choose("Is the course available in Japanese?", "コースは日本語で利用できますか？", language),
    answer: choose("Yes. The full course is presented in Japanese, with English translation available where needed.", "はい。コース全体が日本語で提供されており、必要に応じて英語訳も表示されます。", language)
  },

  // 7. Still need help
  {
    question: choose("Still have questions?", "まだ質問がありますか？", language),
    answer: choose("Didn’t find what you were looking for? Contact our support team anytime at support@miraitraffic.com and we’ll be happy to assist you.", "お探しの情報が見つかりませんでしたか？support@miraitraffic.com までお気軽にお問い合わせください。", language)
  }
];
